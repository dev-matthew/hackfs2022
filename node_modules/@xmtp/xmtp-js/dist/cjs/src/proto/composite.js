...
exports.Composite_Part = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.part !== undefined) {
            messaging_1.EncodedContent.encode(message.part, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.part = messaging_1.EncodedContent.decode(reader, reader.uint32());
                    break;
                case 2:
    ...
    fromJSON(object) {
        return {
            part: isSet(object.part)
                ? messaging_1.EncodedContent.fromJSON(object.part)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.part !== undefined &&
            (obj.part = message.part
                ? messaging_1.EncodedContent.toJSON(message.part)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.part =
            object.part !== undefined && object.part !== null
                ? messaging_1.EncodedContent.fromPartial(object.part)
                : undefined;
        message.composite =
