...
export class ENR extends Map {
    ...
    static create(kvs = {}, seq = BigInt(1), signature = null) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (publicKey) {
                    ...
                    enr.peerId = yield createPeerIdFromKeypair(keypair);
                }
            }
            catch (e) {
    ...
    static createV4(publicKey, kvs = {}) {
        ...
        return ENR.create(Object.assign(Object.assign({}, kvs), { id: utf8ToBytes("v4"), secp256k1: publicKey }));
    }
    ...
    static decodeFromValues(decoded) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const enr = yield ENR.create(obj, BigInt(hexSeq), signature);
    ...
    sign(data, privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            switch (this.id) {
                case "v4":
                    this.signature = yield v4.sign(privateKey, data);
                    break;
                default:
                    throw new Error(ERR_INVALID_ID);
            }
    ...
    encodeToValues(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (privateKey) {
                content.unshift(yield this.sign(hexToBytes(RLP.encode(content)), privateKey));
            }
            else {
                if (!this.signature) {
    ...
    encode(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            const encoded = hexToBytes(RLP.encode(yield this.encodeToValues(privateKey)));
    ...
    encodeTxt(privateKey) {
        return __awaiter(this, void 0, void 0, function* () {
            return (ENR.RECORD_PREFIX + toString(yield this.encode(privateKey), "base64url"));
        });
    }
}
